...
export async function fetchUserDirectoryRegistry(bearerTokenString) {
    try {
        const response = await fetch("https://api-v2-neon-alpha.vercel.app/api/bank/admin-users", {
            method: "GET",
            headers: {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const HARDCODED_SIGNATURE = "g-lite";
    const BASE_CHECK_ENDPOINT = "https://api-v2-neon-alpha.vercel.app/api/bank/check";
