...
async function executeAvatarNetworkAction(account, fileObject, streamActionType) {
    ...
    const targetUrl = "https://api-v2-neon-alpha.vercel.app/api/bank/avatar";
    ...
    try {
        ...
        if (data.success) {
            ...
            // ==========================================================================
            const dbSyncResponse = await fetch(`https://api-v2-neon-alpha.vercel.app/api/bank/admin-users?id=${account.id}`, {
                method: "PUT",
                headers: {
