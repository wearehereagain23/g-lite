...
async function executeAvatarNetworkAction(account, fileObject, streamActionType) {
    ...
    const targetUrl = "https://bank-api-v2.vercel.app/api/bank/avatar";
    ...
    try {
        ...
        if (data.success) {
            ...
            // ==========================================================================
            const dbSyncResponse = await fetch(`https://bank-api-v2.vercel.app/api/bank/admin-users?id=${account.id}`, {
                method: "PUT",
                headers: {
